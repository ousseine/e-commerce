...
class ProductController extends AbstractController
{
    ...
    #[Route('/published/{id}', name: 'app_admin_product_published', methods: ['POST'])]
    public function published(Product $product, Request $request, ProductRepository $productRepository): RedirectResponse
    {
        if ($this->isCsrfTokenValid('delete' . $product->getId(), $request->request->get('_token'))) {
            if (!$product->isIsPublished()) {
